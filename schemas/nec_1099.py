"""Lightweight schema for normalized 1099-NEC documents."""
...
@dataclass
class Nec1099Document:
    doc_type: str = "1099-NEC"
    ...
    box_1_nonemployee_compensation: float = 0.0
    box_4_federal_income_tax_withheld: float = 0.0
    box_5_state_tax_withheld_total: float = 0.0
    ...
    def to_document_dict(self) -> Dict[str, Any]:
        amounts = {
            "box_1_nonemployee_compensation": _as_float(self.box_1_nonemployee_compensation, 0.0),
            "box_4_federal_income_tax_withheld": _as_float(self.box_4_federal_income_tax_withheld, 0.0),
            "box_5_state_tax_withheld_total": _as_float(self.box_5_state_tax_withheld_total, 0.0),
            "nonemployee_compensation": _as_float(self.box_1_nonemployee_compensation, 0.0),
